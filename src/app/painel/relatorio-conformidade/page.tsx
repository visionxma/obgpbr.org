...
const DADOS_FIELDS = [
  ...
  { key:'banco',             label:'BANCO (Extra)' },
  { key:'agencia',           label:'AGÊNCIA (Extra)' },
  { key:'conta_corrente',    label:'CONTA CORRENTE (Extra)' },
];
    ...
    (async () => {
      ...
      if (needsSeed) {
        ...
        const NEW_ITENS = [
          ...
          { relatorio_id: rel.id, secao: 4, codigo: '4.3.', descricao: 'Ata aprovando prestação de contas com parecer do conselho fiscal dos últimos dois exercícios sociais da entidade.', ordem: 10 },
          // Seção 5
      ...
      setDados({
        ...
        conta_corrente:    base.conta_corrente     ?? '15.530-6',

    ...
    (async () => {
      ...
      if (needsSeed) {
        ...
        const NEW_ITENS = [
          ...
          { relatorio_id: rel.id, secao: 2, codigo: '2.6', descricao: 'Ata de Constituição/Fundação', ordem: 6 },
          { relatorio_id: rel.id, secao: 2, codigo: '2.7', descricao: 'Ata de Eleição e Posse Atual', ordem: 7 },
          { relatorio_id: rel.id, secao: 2, codigo: '2.8', descricao: 'Relação de Membros Atual', ordem: 8 },
          { relatorio_id: rel.id, secao: 2, codigo: '2.9', descricao: 'Comprovante de Endereço da Entidade', ordem: 9 },
          { relatorio_id: rel.id, secao: 2, codigo: '2.10', descricao: 'RG/CPF do Representante Legal', ordem: 10 },
          { relatorio_id: rel.id, secao: 2, codigo: '2.11', descricao: 'Comprovante de Endereço do Representante Legal', ordem: 11 },
          // Seção 3

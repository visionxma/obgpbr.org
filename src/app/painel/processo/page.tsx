  ...
  return (
    <>
      {showCnpjStep ? (
        ...
        <div id="painel-top" style={{ width: '100%', maxWidth: 1850, margin: '0 auto', paddingBottom: 60 }}>
            ...
            <section style={{ marginBottom: 32, border: '1px solid var(--site-border)', borderRadius: 'var(--site-radius-xl)', overflow: 'hidden', background: '#fff' }}>
              ...
              {showPaymentScreen ? (
                <div style={{ animation:'panelPageIn .3s ease', background: '#fff' }}>
                  ...
                  {/* ── Payment Body ── */}
                  <div style={{ padding: '24px clamp(16px, 1.5vw, 32px)', display: 'flex', flexDirection: 'column', gap: 16 }}>

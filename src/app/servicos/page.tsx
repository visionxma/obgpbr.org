...
export default function ServicosPage() {
  const servicos = [
    ...
    { icon: FolderArchive, titulo: 'Gestão Documental', texto: 'Organização, controle e atualização da documentação institucional necessária para habilitação em processos seletivos e parcerias entre a administração pública e as organizações da sociedade civil.', color: 'icon-box-green' },
